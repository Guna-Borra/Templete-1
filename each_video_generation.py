...
def VideoGenerate(title, halfway_point, list_of_elements_new):
    ...
    print('Video number & image length , time X', video_number, image_length, x)
...
def Video_Processing(result_links,title,text):
    ...
    command_new ='''ffmpeg '''+"-i"+" "+ video_Final +" "+"-i"+" "+Final_Audio+" -y "+"-shortest"+" "+ video_name 
    command_new = "ffmpeg -i " + output_video + " -i " + Final_Audio + " -shortest " + "-vcodec libx264 -crf 30 " + video_name 
    desc_video_number = int(desc_video_number) + 1
